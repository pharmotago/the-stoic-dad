...
export const module10: Module = {
    ...
    content: {
        ...
        questions: [
            ...
            {
                question: "**Scenario 2: The Wet Socks** (Wisdom/Perspective)\n\nFamily camping trip. Rain. 7-year-old steps in a puddle, soaks sneakers, and whines: 'I'm freezing! Take me home!'\n\n**What is the Stoic Dad response?**",
                options: [
            ...
            },
            {
                ...
                correctAnswer: 2,
                explanation: "Justice requires fairness and a focus on restoration rather than retribution. Reacting in anger violates the virtue."
            },
            {
                question: "**Scenario 4: The Buffet** (Temperance)\n\nYou assume the role of 'vacation dad'. There is an all-you-can-eat buffet and open bar. You are tempted to overindulge because 'you earned it'.\n\n**How do you exercise Temperance?**",
                options: [
            ...
            },
            {
                ...
                correctAnswer: 3,
                explanation: "Correct. The advanced Stoic Dad layers these protocols simultaneously to achieve instant calm."
            }
        ],
        audit: [
            ...
            "I accept that anger is a temporary madness and a sign of weakness, not strength. I commit to using the 'Tactical Pause' before reacting.",
        ...
        challenge: "Congratulations. You have completed the curriculum. Your final challenge is life itself. Go be the rock your family needs."
    }
};
